  ...
  return (
    <View style={styles.container}>
      ...
      <Svg width="28" height="28" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <View style={styles.detail}>
          ...
          <Text style={styles.details}>
            Energy Manager responsible for monitoring and optimizing resource consumption across Green Tower HQ and Logistics Center
          </Text>
        </View>
      </View>
      ...
      <Svg width="28" height="28" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        <Path d="M11 21.5C16.5228 21.5 21 17.0228 21 11.5C21 5.97715 16.5228 1.5 11 1.5C5.47715 1.5 1 5.97715 1 11.5C1 17.0228 5.47715 21.5 11 21.5Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <Path d="M9.88867 7.05554V12.6111H15.4442" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </Svg>
